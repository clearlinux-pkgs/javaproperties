...
License  : MIT
Requires: javaproperties-license = %{version}-%{release}
...
%package license
Summary: license components for the javaproperties package.
Group: Default

%description license
license components for the javaproperties package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637691338
...
export MAKEFLAGS=%{?_smp_mflags}
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/javaproperties
cp %{_builddir}/javaproperties-0.8.1/LICENSE %{buildroot}/usr/share/package-licenses/javaproperties/c2a412dfea07d82b46c697714f9431f34a48eb62
...
/usr/share/package-licenses/javaproperties/c2a412dfea07d82b46c697714f9431f34a48eb62
